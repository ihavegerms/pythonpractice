...
databaseServerIP            = "172.17.0.2"  # IP address of the MySQL database server
databaseUserName            = "root"       # User name of the database server
databaseUserPassword        = "darrensmells"           # Password for the database user

newDatabaseName             = "ninjaPhoneBooth" # Name of the database that is to be created
